...
export default async function Home() {
  ...
  return (
    <MotionProvider>
      <Navbar overlay site={site} isLive={livestream.isLive} />
      <PublicMotionChrome />
      <main>
        <section className="relative isolate flex min-h-[760px] items-end overflow-hidden bg-primary text-white lg:min-h-screen">
          ...
          <div className="container-site grid gap-12 pb-12 pt-40 lg:grid-cols-[1fr_320px] lg:items-end lg:pb-16">
            ...
            >
              ...
              >
                Rencanakan kunjungan <ChevronRight className="size-4" />
              </Link>
            </MotionDiv>
          </div>
          <a
          ...
          <div className="container-site grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
              ...
              <Button asChild variant="dark" size="lg" className="mt-9">
                <Link href="/tentang">
                  Mengenal Kami Lebih Dekat <ArrowRight className="size-4" />
                </Link>
              </Button>
            </div>
          </div>
          ...
          <div className="container-site">
            <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
              ...
              <Button asChild variant="secondary">
                <Link href="/jadwal-ibadah">
                  Lihat semua jadwal <ArrowRight className="size-4" />
                </Link>
              </Button>
            </div>
        ...
        <MotionSection className="section-pad bg-cream">
          <div className="container-site">
            <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
              ...
              <Button asChild variant="secondary">
                <Link href="/kegiatan">
                  Lihat Semua Kegiatan <ArrowRight className="size-4" />
                </Link>
              </Button>
            </div>
        ...
        <MotionSection className="section-pad bg-white">
          <div className="container-site">
            <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
              ...
              <Button asChild variant="secondary">
                <Link href="/khotbah">
                  Lihat Semua Khotbah <ArrowRight className="size-4" />
                </Link>
              </Button>
            </div>
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <MotionSection className="section-pad bg-cream">
          <div className="container-site">
            <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
              ...
              <Button asChild variant="secondary">
                <Link href="/galeri">
                  Lihat Semua Galeri <ArrowRight className="size-4" />
                </Link>
              </Button>
            </div>
