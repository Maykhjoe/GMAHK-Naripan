...
import { EventCard, SermonCard, MinistryCard, ServiceScheduleCard, ArticleCard } from "@/components/cards/content-cards";
import { MotionProvider } from "@/components/motion/motion-provider";
import { PublicMotionChrome } from "@/components/motion/public-motion-chrome";
import { heroReveal, MotionDiv, MotionSection, scaleIn } from "@/components/motion/motion-section";
...
export default async function Home() {
  ...
  return <MotionProvider><Navbar overlay site={site} isLive={livestream.isLive} /><PublicMotionChrome /><main>
    <section className="relative isolate flex min-h-[760px] items-end overflow-hidden bg-primary text-white lg:min-h-screen">
      <Image src="https://images.unsplash.com/photo-1561448817-f17eed390089?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Suasana hangat persekutuan gereja" fill priority className="-z-30 object-cover motion-safe:animate-[hero-ken-burns_20s_ease-out_both]" sizes="100vw" />
  ...
  </main><Footer site={site} /></MotionProvider>;
}
