...
export const adminResources: Record<string, AdminResource> = {
  ...
  departemen: {
    ...
    fields: [
      ...
      {
        key: "coordinator_photo_url",
        label: "URL Foto Koordinator",
        type: "url",
        sourcePath: "seo.coordinatorPhoto",
        hidden: true,
      },
      {
        key: "coordinator_photo_id",
        label: "Foto Koordinator",
        type: "image",
        sourcePath: "seo.coordinatorPhotoId",
        uploadEndpoint: "/api/admin/departemen/coordinator-photo",
        urlField: "coordinator_photo_url",
        accept: "image/jpeg,image/png,image/webp",
        help: "Opsional. JPG, PNG, atau WebP maksimal 5 MB. Jika dikosongkan, pelayanan tetap dapat disimpan.",
      },
      {
        key: "contact",
  ...
  galeri: {
    ...
    fields: [
      ...
      { key: "display_order", label: "Urutan Tampilan", type: "number", defaultValue: 0 },
      {
        key: "status",
        label: "Status",
        type: "select",
